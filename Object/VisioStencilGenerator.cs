...
namespace GenerateAzureStencilsfromSVGIcons.Object
{
    ...
    {
        private readonly AppPathsConfig _paths;
        private readonly NameFormatter _nameFormatter;
        private static string? _fontType;
        private static int _fontSize;

        public VisioStencilGenerator(AppPathsConfig paths, NameFormatter nameFormatter, string fontType, int fontSize)
        {
        ...
        public void GenerateStencils(IEnumerable<IGrouping<string?, string>> groups)
        {
            ...
            try
            {
                ...
                foreach (var group in groupList)
                {
                    ...
                    string stencilPath = Path.Combine(_paths.OutputFolder, stencilName);
